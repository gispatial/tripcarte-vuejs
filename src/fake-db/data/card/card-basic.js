...
const data = {
  TripCarte_product_1: {
    ...
    title: "Vuexy Admin",
    subtitle: "By TripCarte Creative Studio",
    subtitle_2: "Elite Author",
  },
  TripCarte_product_sales_1: {
...
mock.onGet("/api/users/TripCarte/product/1").reply(() => {
  return [200, data.TripCarte_product_1];
});

mock.onGet("/api/users/TripCarte/product/sales/1").reply(() => {
  return [200, data.TripCarte_product_sales_1];
});

mock.onGet("/api/users/TripCarte/product/goals/1").reply(() => {
  return [200, data.TripCarte_product_goal_1];
});
